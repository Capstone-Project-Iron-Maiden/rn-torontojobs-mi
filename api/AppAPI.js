...
export function loadHomeData() {
    firebase.database().ref('/torontojobsDBMI/homescreen').on('value', (snapshot) => {
...
export function loadScheduleData() {
  firebase.database().ref('/torontojobsDBMI/schedulescreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadExhibitorData() {
  firebase.database().ref('/torontojobsDBMI/exhibitorscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadSpeakerData() {
  firebase.database().ref('/torontojobsDBMI/speakerscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadTicketData() {
  firebase.database().ref('/torontojobsDBMI/ticketscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
